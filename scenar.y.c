...
#line 154 "scenar.y"
    {
          if(first_layer) { IIM_Free(first_layer); first_layer=0; }
          first_layer = IIM_Load_DisplayFormatAlpha((yyvsp[(2) - (2)].str));
        }
    break;
...
#line 158 "scenar.y"
    {
          if(back_layer)  { IIM_Free(back_layer);  back_layer=0;  }
          back_layer = IIM_Load_DisplayFormatAlpha((yyvsp[(2) - (2)].str));
        }
    break;
...
#line 162 "scenar.y"
    {
          dec_vectorx = 0.01f * (yyvsp[(2) - (4)].i);
          dec_vectory = 0.01f * (yyvsp[(4) - (4)].i);
        }
    break;
